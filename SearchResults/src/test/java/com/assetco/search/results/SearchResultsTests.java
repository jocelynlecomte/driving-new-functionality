...
public class SearchResultsTests {
    ...
    @Test
    public void shouldHaveDefaultUserSegment() {
        assertThat(results.getUserSegment()).isEqualTo(UserSegment.NewsMedia);
    }

    @ParameterizedTest
    @EnumSource(UserSegment.class)
    public void shouldGetProperUserSegment(UserSegment userSegment) {
        results.setUserSegment(userSegment);
        assertThat(results.getUserSegment()).isEqualTo(userSegment);
    }
