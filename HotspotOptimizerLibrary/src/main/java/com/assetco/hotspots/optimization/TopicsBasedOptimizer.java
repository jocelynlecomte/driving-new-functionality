...
class TopicsBasedOptimizer {
    public boolean optimize(SearchResults searchResults, AssetTopicsSource hotTopicsSource) {
        ...
        while (iterator.hasNext()) {
            ...
            // We've removed the highlight hotspot building from this spot
            // It looks more or less completely unrelated to the rest of the loop
        ...
        // A new loop as been generated to search for items with hot topics
